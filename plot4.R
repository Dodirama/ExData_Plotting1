...
with(household, {
  ...
  plot(Date.Time.2, Global_active_power, type = "l", 
       ylab = "Global Active Power (kilowatts)",
       xlab = "")
  
  plot(Date.Time.2, Voltage, type = "l", xlab = "datetime")
  ...
  legend("topright", border = NULL,
         legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), 
         col = c("black", "red", "blue"), lty = 1, bty = "n")
  
  plot(Date.Time.2, Global_reactive_power, type = "l", xlab = "datetime") 
